          ...
          <div className="h-[400px] md:h-[700px] lg:h-[540px] overflow-scroll">
            ...
            <div className="bg-[#262837] p-4 rounded-xl mb-4">
              <div className="grid grid-cols-6 mb-4">
                {/* Product description */}
                <div className="col-span-4 flex items-center gap-3">
                  <img src="food2.png" className="w-10 h-10 object-cover" />
                  <div>
                    <h5 className="text-sm">Dish two</h5>
                    <p className="text-xs text-gray-500">$2.29</p>
                  </div>
                </div>
                {/* Qty */}
            ...
            <div className="bg-[#262837] p-4 rounded-xl mb-4">
              <div className="grid grid-cols-6 mb-4">
                {/* Product description */}
                <div className="col-span-4 flex items-center gap-3">
                  <img src="food3.png" className="w-10 h-10 object-cover" />
                  <div>
                    <h5 className="text-sm">Dish three</h5>
                    <p className="text-xs text-gray-500">$2.29</p>
                  </div>
                </div>
                {/* Qty */}
            ...
            <div className="bg-[#262837] p-4 rounded-xl mb-4">
              <div className="grid grid-cols-6 mb-4">
                {/* Product description */}
                <div className="col-span-4 flex items-center gap-3">
                  <img src="food4.png" className="w-10 h-10 object-cover" />
                  <div>
                    <h5 className="text-sm">Dish four</h5>
                    <p className="text-xs text-gray-500">$2.29</p>
                  </div>
                </div>
                {/* Qty */}
